...
time-persistent statistics. The package also contains two queueing data sets
...
independent streams of uniform(0,1) random numbers.  If the `rstream` package is
not already installed, the previous step will install `rstream` automatically.
