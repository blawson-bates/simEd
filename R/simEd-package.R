...
#'  variates for two discrete and five continuous distributions:
#'  \itemize{
#'     \item discrete: \code{\link{vbinom}}, \code{\link{vgeom}}
#'     \item continuous: \code{\link{vexp}}, \code{\link{vgamma}},
#'        \code{\link{vnorm}}, \code{\link{vunif}}, \code{\link{vweibull}}
#'  }
...
#'  two discrete and five continuous distributions:
#'  \itemize{
#'     \item discrete: \code{\link{ibinom}}, \code{\link{igeom}}
#'     \item continuous: \code{\link{iexp}}, \code{\link{igamma}},
#'        \code{\link{inorm}}, \code{\link{iunif}}, \code{\link{iweibull}}
#'  }
...
#'  arrival and service process functions.
#'
...
#'
#' @importFrom graphics  
#'  axis  clip    curve  hist      lines      mtext  par
#'  plot  points  rect   segments  strheight  text   title   rasterImage
#'
#' @importFrom grDevices 
#'  col2rgb   rgb      pdf.options
#'  dev.list  dev.new  dev.size     dev.off
#'
#' @importFrom methods  
#' new
#'
#' @importFrom stats    
#'  runif    IQR      ecdf          knots     plot.ecdf
#'  dbeta    pbeta    qbeta         dbinom    pbinom    qbinom   
#'  dcauchy  pcauchy  qcauchy       dchisq    pchisq    qchisq 
#'  dexp     pexp     qexp          df        pf        qf
#'  dgamma   pgamma   qgamma        dgeom     pgeom     qgeom
#'  dlnorm   plnorm   qlnorm        dlogis    plogis    qlogis 
#'  dnbinom  pnbinom  qnbinom       dnorm     pnorm     qnorm    
#'  dpois    ppois    qpois         dt        pt        qt 
#'  dunif    punif    qunif         dweibull  pweibull  qweibull
#'
#' @importFrom
#'  utils  flush.console  setTxtProgressBar  txtProgressBar
NULL
